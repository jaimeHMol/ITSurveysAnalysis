...
class DataProcess(object):
    ...
    def linear_regression(self, col_to_predict, cols=None, cols_to_remove=None, num_splits=25, graph=True, num_vars_graph=10):
    ...
    def random_forest(self, col_to_predict, cols=None, cols_to_remove=None, num_splits=25, graph=True, num_vars_graph=10):
        cols = [] if cols is None else cols
        cols_to_remove = [] if cols_to_remove is None else cols_to_remove
